...
export 'soil_model.dart';

class SoilWidget extends StatefulWidget {
  const SoilWidget({super.key});

  @override
  State<SoilWidget> createState() => _SoilWidgetState();
}

class _SoilWidgetState extends State<SoilWidget> with TickerProviderStateMixin {
  late SoilModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SoilModel());
                  ...
                  children: [
                    ...
                    Padding(
                      padding: const EdgeInsetsDirectional.fromSTEB(
                          16.0, 12.0, 16.0, 16.0),
                      child: Text(
                        'Soil is more than a medium for plant growth; it\'s a living ecosystem essential for sustainable farming. Understanding this community boosts crop yields, reduces chemical use, and ensures long-term sustainability. A healthy soil ecosystem creates a resilient environment that benefits both the land and its people.',
                        style:
                                ...
                                children: [
                                  Row(
                                    ...
                                    children: [
                                      ClipRRect(
                                        ...
                                        child: Image.asset(
                                          'assets/images/jona_hair_cut.jpg',
                                          width: 40.0,
                                          height: 40.0,
                                          fit: BoxFit.cover,
                                        ),
                                  ...
                                  Padding(
                                    padding: const EdgeInsetsDirectional.fromSTEB(
                                        0.0, 12.0, 0.0, 0.0),
                                    child: Text(
                                      'A new study has shown that microplastics in soil can be harmful to worms, causing them to lose weight. ',
                                      style: FlutterFlowTheme.of(context)
                                          .labelMedium
                                          .override(
                                            fontFamily: 'Inter',
