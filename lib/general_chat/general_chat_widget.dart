...
import 'general_chat_model.dart';
export 'general_chat_model.dart';

class GeneralChatWidget extends StatefulWidget {
  const GeneralChatWidget({super.key});

  @override
  State<GeneralChatWidget> createState() => _GeneralChatWidgetState();
}

class _GeneralChatWidgetState extends State<GeneralChatWidget>
    with TickerProviderStateMixin {
  late GeneralChatModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => GeneralChatModel());
                  ...
                  children: [
                    ...
                    Padding(
                      padding: const EdgeInsetsDirectional.fromSTEB(
                          16.0, 12.0, 16.0, 16.0),
                      child: Text(
                        'This is a space where you can freely ask any questions related to agriculture. Whether you\'re curious about farming techniques, crop management, soil health, or new technologies in agriculture, feel free to share your thoughts. Everyone is welcome to discuss and exchange ideas to help improve knowledge and practices in the field.',
                        style:
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  ClipRRect(
                                    borderRadius: BorderRadius.circular(8.0),
                                    child: Image.asset(
                                      'assets/images/whats-this-plant-my-parents-are-convinced-im-trying-to-grow-v0-p2ls9832vfgd1.webp',
                                      width: 200.0,
                                      height: 200.0,
                                      fit: BoxFit.cover,
                                    ),
