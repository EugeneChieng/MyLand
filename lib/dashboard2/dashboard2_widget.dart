...
class Dashboard2Widget extends StatefulWidget {
  /// generate me a pofile page .At the top part of the page it will be a user
  /// avatar and beside it is user name,under username is user id. For this part
  /// the background colour is blue colour with changing gradient and cover
                            ...
                            Column(
                              ...
                              children: [
                                Container(
                                  ...
                                  height:
                                      MediaQuery.sizeOf(context).height * 0.197,
                                                ...
                                                child: ClipRRect(
                                                  borderRadius:
                                                      BorderRadius.circular(
                                                          40.0),
                                                  child: Image.network(
                                                    'https://images.unsplash.com/photo-1663893364107-a6ecd06cf615?w=500&h=500',
                                                    width: 80.0,
                                                    height: 80.0,
                                                    fit: BoxFit.cover,
                                                  ),
                                ...
                                children: [
                                  ...
                                  Align(
                                    ...
                                    child: ClipRRect(
                                      borderRadius: BorderRadius.circular(8.0),
                                      child: Image.asset(
                                        'assets/images/{E19B79B8-2AB7-4406-9C2C-B555FC5B1630}.png',
                                        width: 324.0,
                                        height: 150.0,
                                        fit: BoxFit.cover,
                                      ),
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              Material(
                                ...
                                child: Container(
                                  width:
                                      MediaQuery.sizeOf(context).width * 0.459,
                                  height: 100.0,
                                  decoration: BoxDecoration(
                                    color: FlutterFlowTheme.of(context)
                                        .secondaryBackground,
                            ...
                            child: Container(
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Text(
                                      'Crop Status and  Health Analysis',
                                      style: FlutterFlowTheme.of(context)
                                          .headlineSmall
                                          .override(
                                            fontFamily: 'Inter Tight',
